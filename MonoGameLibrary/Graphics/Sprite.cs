...
public class Sprite
{
    ...
    /// </summary>
    /// <remarks>
    /// Default value if SpriteEffects.None
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// Width is calculated by multiplying the width of the source texture region by the x-scale
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// Height is calculated by multiplying the height of the source texture region by the y-scale
    /// </remarks>
    ...
    /// <summary>
    /// Creates a new sprite using a specified source texture region
    /// </summary>
    /// <param name="region">The texture region to use as the source texture regions</param>
    ...
    {
        Origin = new Vector2(Region.Width, Region.Height) / 2f;
    }
